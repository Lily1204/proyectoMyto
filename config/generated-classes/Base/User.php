...
abstract class User implements ActiveRecordInterface
{
    ...
    public function setCorreo($v)
    {
        ...
        if ($this->correo !== $v) {
            $this->correo = $v;
            $this->modifiedColumns[UserTableMap::COL_CORREO] = true;
        }
    ...
    public function setNombre($v)
    {
        ...
        if ($this->nombre !== $v) {
            $this->nombre = $v;
            $this->modifiedColumns[UserTableMap::COL_NOMBRE] = true;
        }
    ...
    public function setEdad($v)
    {
        ...
        if ($this->edad !== $v) {
            $this->edad = $v;
            $this->modifiedColumns[UserTableMap::COL_EDAD] = true;
        }
    ...
    public function setSexo($v)
    {
        ...
        if ($this->sexo !== $v) {
            $this->sexo = $v;
            $this->modifiedColumns[UserTableMap::COL_SEXO] = true;
        }
    ...
    public function hydrate($row, $startcol = 0, $rehydrate = false, $indexType = TableMap::TYPE_NUM)
    {
        try {
            ...
            $col = $row[TableMap::TYPE_NUM == $indexType ? 0 + $startcol : UserTableMap::translateFieldName('Correo', TableMap::TYPE_PHPNAME, $indexType)];
            $this->correo = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 1 + $startcol : UserTableMap::translateFieldName('Nombre', TableMap::TYPE_PHPNAME, $indexType)];
            $this->nombre = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 2 + $startcol : UserTableMap::translateFieldName('Edad', TableMap::TYPE_PHPNAME, $indexType)];
            $this->edad = (null !== $col) ? (int) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 3 + $startcol : UserTableMap::translateFieldName('Sexo', TableMap::TYPE_PHPNAME, $indexType)];
    ...
    protected function doInsert(ConnectionInterface $con)
    {
        ...
        if ($this->isColumnModified(UserTableMap::COL_CORREO)) {
            $modifiedColumns[':p' . $index++]  = 'correo';
        }
        if ($this->isColumnModified(UserTableMap::COL_NOMBRE)) {
            $modifiedColumns[':p' . $index++]  = 'nombre';
        }
        if ($this->isColumnModified(UserTableMap::COL_EDAD)) {
            $modifiedColumns[':p' . $index++]  = 'edad';
        }
        if ($this->isColumnModified(UserTableMap::COL_SEXO)) {
    ...
    public function fromArray($arr, $keyType = TableMap::TYPE_PHPNAME)
    {
        ...
        if (array_key_exists($keys[2], $arr)) {
            $this->setEdad($arr[$keys[2]]);
        }
        if (array_key_exists($keys[3], $arr)) {
            $this->setSexo($arr[$keys[3]]);
        }
    }
    ...
    public function buildCriteria()
    {
        ...
        if ($this->isColumnModified(UserTableMap::COL_CORREO)) {
            $criteria->add(UserTableMap::COL_CORREO, $this->correo);
        }
        if ($this->isColumnModified(UserTableMap::COL_NOMBRE)) {
            $criteria->add(UserTableMap::COL_NOMBRE, $this->nombre);
        }
        if ($this->isColumnModified(UserTableMap::COL_EDAD)) {
            $criteria->add(UserTableMap::COL_EDAD, $this->edad);
        }
        if ($this->isColumnModified(UserTableMap::COL_SEXO)) {
            $criteria->add(UserTableMap::COL_SEXO, $this->sexo);
        }
    ...
    /**
     * Generic method to set the primary key (correo column).
     *
     ...
     * @return ObjectCollection|ChildArticle[] List of ChildArticle objects
     */
    public function getArticlesJoinActivity(Criteria $criteria = null, ConnectionInterface $con = null, $joinBehavior = Criteria::LEFT_JOIN)
    {
        $query = ChildArticleQuery::create(null, $criteria);
    ...
    public function setUserActivityCategories(Collection $userActivityCategories, ConnectionInterface $con = null)
    {
        ...
        foreach ($userActivityCategoriesToDelete as $userActivityCategoryRemoved) {
            $userActivityCategoryRemoved->setUser(null);
        }
    ...
    protected function doAddUserActivityCategory(ChildUserActivityCategory $userActivityCategory)
    {
        ...
        $userActivityCategory->setUser($this);
    }
    ...
    public function removeUserActivityCategory(ChildUserActivityCategory $userActivityCategory)
    {
        if ($this->getUserActivityCategories()->contains($userActivityCategory)) {
            ...
            $userActivityCategory->setUser(null);
        }
     ...
     * @return ObjectCollection|ChildUserActivityCategory[] List of ChildUserActivityCategory objects
     */
    public function getUserActivityCategoriesJoinActivityCategory(Criteria $criteria = null, ConnectionInterface $con = null, $joinBehavior = Criteria::LEFT_JOIN)
    {
        $query = ChildUserActivityCategoryQuery::create(null, $criteria);
        $query->joinWith('ActivityCategory', $joinBehavior);
